...
const fetchCurrentLocation = async () => {
  ...
  return (
    <section 
      ...
      {data && (
        <FadeInWrapper className='z-20'>
          <div className={`z-10 grid grid-cols-1 md:grid-cols-[40%_60%] mx-auto max-w-7xl w-full h-full rounded-md overflow-hidden transition duration-300 ease-in-out`}>
            {/* Left Side of Cont */}
            <div 
